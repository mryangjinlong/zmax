...
public class DeviceStatus {
    private final static int PRINTER_STATUS_WORK = 0;   //打印机状态正常
    private final static int PRINTER_STATUS_FAULT = 1;  //打印机状态故障

    private final static int SCANNER_STATUS_WORK = 0;   //扫描仪正常状态
    private final static int SCANNER_STATUS_FAULT = 1;  //扫描仪故障状态
